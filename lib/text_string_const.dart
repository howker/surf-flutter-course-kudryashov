...
const String wantToVisit = 'Хочу посетить';
const String alreadyVisited = 'Посетил';
const String planned = 'Запланировано на 12 окт. 2020';
const String close = 'Закрыто до 09:00';
const String aimReached = 'Цель достигнута 12 окт. 2020';
